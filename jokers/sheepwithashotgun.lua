...
SMODS.Joker{ --Sheep With A Shotgun
    key = "sheepwithashotgun",
    config = {
        extra = {
            discount_amount = '5',
            reroll_amount = '1e+27'
    ...
    loc_txt = {
        ['name'] = 'Sheep With A Shotgun',
        ['text'] = {
            [1] = '{C:money}-5{} Dollars of shop items, Rerolls are Free',
            [2] = '{s:0.79,C:inactive}erm actually there is only 1e+27 rerolls{}'
        },
        ['unlock'] = {
    ...
    add_to_deck = function(self, card, from_debuff)
        ...
        SMODS.change_free_rerolls(1e+27)
    end,
...
function Card:set_cost()
    ...
    if next(SMODS.find_card("j_toontast_sheepwithashotgun")) then
        if (self.ability.set == 'Joker' or self.ability.set == 'Tarot' or self.ability.set == 'Planet' or self.ability.set == 'Spectral' or self.ability.set == 'Enhanced' or self.ability.set == 'Booster' or self.ability.set == 'Voucher') then
            self.cost = math.max(0, self.cost - (5))
        end
    end
